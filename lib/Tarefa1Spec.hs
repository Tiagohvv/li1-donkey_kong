...
p1 = Personagem (0,0) Jogador (4,4) Este (1,1) False False 10 0 (False, 0.0)
...
p7 = Personagem (0,0) Jogador (3,3) Este (1,1) False False 10 0 (False, 0.0)
p8 = Personagem (0,0) Fantasma (3.1,3) Oeste (1,1) True False 2 0 (False, 0.0)
...
pl2 = Personagem (0.0,0.0) Jogador (0.0,6.5) Este (1,1) False False 10 0 (False, 0.0)

teste6 = "T6: Jogador colide com limite lateral " ~: True ~=? colisoesParede gameMap1 pl2

pl3 = Personagem (0.0,0.0) Jogador (50.0,0.2) Este (1,1) False False 10 0 (False, 0.0)

teste7 = "T7: Jogador colide com limite superior " ~: True ~=? colisoesParede gameMap1 pl3

pl4 = Personagem (0.0,0.0) Jogador (3.0,5.0) Este (1,1) False False 10 0 (False, 0.0)
